...
```powershell
git clone https://github.com/sinascorpion/flop_technocore.git
...
```console
python technocore_agent.py proof https://github.com/sinascorpion/flop_technocore FULL_COMMIT_HASH --output contribution-proof.json
